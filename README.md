...
This is one input into what my [Package Registry Scraper](https://apify.com/ponderable_hydrometer/package-registry-scraper) actor normalizes into one row per dependency across all three registries. The story behind why I went looking for this is on dev.to: [I Wanted to Check If a Package Had Ever Shipped Malware. npm, PyPI and crates.io All Erased the Evidence.](https://dev.to/ronin13/i-wanted-to-check-if-a-package-had-ever-shipped-malware-npm-pypi-and-cratesio-all-erased-the-evidence)
